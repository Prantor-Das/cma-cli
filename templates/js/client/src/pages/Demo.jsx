...
export default function Demo() {
  return (
    <div className="space-y-12 my-4">
      ...
      {/* Developer Info */}
      <div className="flex flex-col md:flex-row justify-between items-center gap-8 border-t-1 border-zinc-300 dark:border-zinc-700 pt-6 mt-14 max-w-5xl mx-auto">
...
function DocumentationCard({ icon: Icon, title, items }) {
  return (
